...
const PrivacyPolicyPage = () => {
  return (
    <>
      <CurrentPageNav props={"Privacy and Policy"} />
      <div className="container mt-16 mx-auto w-[556px] text-base font-light leading-relaxed text-gray-400">
        ...
        <p>
          This privacy policy will help you understand how Auction app uses and
          protects the data you provide to us when you visit and use our Auction
          app.
        </p>
        <p>
